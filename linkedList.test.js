...
describe("#insertAtHead", () => {
  test("it add the element to the begining to the liset", () => {
...
describe("#insertAtIndex", () => {
  describe("with index less than 0", () => {
    test("it does not change the linked list", () => {
      const ll = LinkedList.fromValues(10, 20);
  ...
  describe("with index greter than the list length", () => {
    test("it does not change the linked list", () => {
      const ll = LinkedList.fromValues(10, 20);
